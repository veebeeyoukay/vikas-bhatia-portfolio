...
const MOCK_ISSUES: Issue[] = [
    ...
    { id: 'ISS-004', title: 'Placement Count Discrepancies', description: 'JP Morgan Chase shows 11 placements in Dynamics vs 17 in Tracker. E2 Generations shows 7 vs 15.', status: 'in-progress', priority: 'critical', category: 'data-integrity', affectedRecords: null, department: 'backoffice', dateIdentified: '2024-12-05' },
    { id: 'ISS-005', title: 'Missing Start/End Dates on Placements', description: 'Some placement records missing start and end dates. Required for ADP integration.', status: 'in-progress', priority: 'medium', category: 'data-completeness', affectedRecords: null, department: 'backoffice', dateIdentified: '2024-12-05' },
    { id: 'ISS-006', title: 'Work Department Not Mapped', description: 'Work department field needed for ADP payroll not appearing on company records.', status: 'in-progress', priority: 'high', category: 'data-mapping', affectedRecords: 35, department: 'accounting', dateIdentified: '2024-12-05' },
    { id: 'ISS-007', title: 'Jobs Not Visible Without Manual Toggle', description: 'Open jobs require manual "Open" toggle in migrated data tab to appear in job lists.', status: 'pending', priority: 'medium', category: 'usability', affectedRecords: null, department: 'sales', dateIdentified: '2024-12-03' },
    { id: 'ISS-008', title: 'Available Start Date Field Broken', description: 'Available start date field on submission form not functioning during candidate screening.', status: 'pending', priority: 'low', category: 'functionality', affectedRecords: null, department: 'recruiting', dateIdentified: '2024-12-05' },
    { id: 'ISS-009', title: 'SharePoint Document Migration Pending', description: 'Historical documents not yet visible. SharePoint integration scheduled as final migration step.', status: 'pending', priority: 'medium', category: 'integration', affectedRecords: null, department: 'all', dateIdentified: '2024-11-01' }
];
        ...
        <div style={{
            ...
            <div style={{
                ...
                <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '12px', marginTop: '30px' }}>
                    Prepared by Vikas Bhatia • December 2024
                </p>
            </div>
        </div>
    );
    ...
    <div style={{ background: BRAND.white, borderRadius: '16px', overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ padding: '24px', color: BRAND.navyDark }}>
            <div style={{ display: 'grid', gridTemplateColumns: '80px 1fr', gap: '8px 16px', fontSize: '14px', marginBottom: '20px', paddingBottom: '20px', borderBottom: `1px solid ${BRAND.greyLight}` }}>
                ...
                <span style={{ color: BRAND.grey }}>Date:</span><span>December 5, 2024</span>
            </div>
...
const Contact = () => (
    <div style={{ background: `linear-gradient(135deg, ${BRAND.navy}, ${BRAND.navyLight})`, borderRadius: '16px', padding: '40px', textAlign: 'center' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '12px', marginTop: '40px' }}>© 2024 Vikas Bhatia • Prepared for IT Resources Corp</p>
    </div>
);
