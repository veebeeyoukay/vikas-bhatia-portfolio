      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              This site outlines my understanding of Zenity's business objectives and presents a proposed vision for a scalable security program, addressing both immediate needs and long-term objectives to support our continued growth and market leadership in AI Agent security.
            </p>
          </div>
        </div>
      </div>
